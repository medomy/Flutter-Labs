...
import 'package:json_api_example/screens/comments.dart';
import 'package:json_api_example/screens/posting.dart';
          ...
          actions: [
            IconButton(onPressed: () {
               Navigator.push(context, MaterialPageRoute(
                      builder: (c) =>
                        PostingScreen()));}, icon: Icon(Icons.send)),
          ],
        ),
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(
                        builder: (c) =>
                        CommentScreen(postDataList[index].id)
                      ));
                    },
